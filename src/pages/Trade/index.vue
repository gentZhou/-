  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeIsDefault(userAddress)">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ defaultUser.consignee }}</span> 电 话：<span>{{
          defaultUser.phoneNum
        }}</span>
      </div>
    </div>
  ...
  export default {
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let tradeInfo={
          consignee: this.defaultUser.consignee,            //用户名
          consigneeTel: this.defaultUser.phoneNum,          //用户联系电话
          deliveryAddress: this.defaultUser.userAddress,    //用户地址
